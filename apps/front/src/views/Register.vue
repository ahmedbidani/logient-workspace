<template>
  ...
  const form = reactive({ email: null, password: null, password_confirmation: null });
  ...
  const onSubmit = async () => {
    try {
      loading.value = true;
      const response = await axios.post(`http://localhost:3333/api/v1/security/signup`, form)
